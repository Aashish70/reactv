...
const App = () => {
  ...
  const fetchData = async () => {
    ...
    //   url: 'https://6922ff9909df4a492323f233.mockapi.io/users'
    // })
  ...
  const editData = async () => {
    // await axios({
    //   url: `https://6922ff9909df4a492323f233.mockapi.io/users/${formDetails.id}`,
    //   method: 'put',
    //   data: formDetails
    // })
  ...
  const deleteUser = async (id) => {
    // await axios({
    //   url: `https://6922ff9909df4a492323f233.mockapi.io/users/${id}`,
    //   method: 'delete',
    // })
